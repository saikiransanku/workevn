              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <RefreshCw
                    size={17}
                    className={
                      status === "finding-workers" ? "animate-spin" : ""
                    }
                  />
                  Refresh workers
                </button>
                ...
                <a
                  href="/workers"
                  className="inline-flex items-center justify-center gap-2 rounded-md border border-black/10 bg-white px-4 py-3 text-sm font-black"
                >
                  View All Workers
                  <ArrowRight size={16} />
                </a>
